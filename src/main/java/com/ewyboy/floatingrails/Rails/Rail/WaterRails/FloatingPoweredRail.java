...
public class FloatingPoweredRail extends BlockRailPowered {

    public FloatingPoweredRail() {
        super();
        setCreativeTab(null);
    }
    ...
    public Item getItemDropped(int i, Random random, int idk) {
        return Rails.FloatingRailSpawnerPowered;
    }
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        TexturePowered = register.registerIcon(TexturePath.TextureLocation + ":" + RailInfo.FloatingRailPowered1Texture);
    }
