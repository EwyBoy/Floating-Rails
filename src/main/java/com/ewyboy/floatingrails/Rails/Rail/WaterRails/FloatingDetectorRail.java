...
public class FloatingDetectorRail extends BlockRailDetector {

    public FloatingDetectorRail() {
        super();
        setCreativeTab(null);
    }
    ...
    public Item getItemDropped(int i, Random random, int idk) {
        return Rails.FloatingRailSpawnerDetection;
    }
    ...
    {
        Texture = register.registerIcon(TexturePath.TextureLocation + ":" + RailInfo.FloatingRailDetector0Texture);
        TexturePowered = register.registerIcon(TexturePath.TextureLocation + ":" + RailInfo.FloatingRailDetector1Texture);
    }
