package com.ewyboy.floatingrails.Rails.RailSpawners.LavaRailsSpawners;
...
public class FloatingRailLavaSpawnerActivated extends Item {

    public FloatingRailLavaSpawnerActivated() {
        super();
    ...
    public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer player)
    {
        ...
        else
        {
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                {
                    world.setBlock(i, j + 1, k, Rails.FloatingActivatedLavaRail);
